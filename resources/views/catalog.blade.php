            ...
            <div>
                ...
                <p class="cat-hero__lede">
                    @if($filters['q'])
                        ...
                        <strong>{{ $products->total() }}</strong> {{ trans_choice('банка|банки|банок', $products->total()) }}.
                    @else
                        в банках сегодня — <strong>{{ $totalActive }}</strong> {{ trans_choice('сорт|сорта|сортов', $totalActive) }} варенья.
        ...
        <div class="cat-main">
            ...
            <div class="cat-toolbar">
                <div class="cat-toolbar__count">
                    ...
                    {{ trans_choice('банка|банки|банок', $products->total()) }}
                </div>
