    ...
    <div class="container">
        ...
        <header class="cauldron-page__head">
            ...
            <p>
                ...
                Бросай в котёл ягоды, специи и пожелания —<br>
                Дарина сварит банку, которой нет ни у кого.
            </p>
        </header>
        ...
        <div class="cauldron-gate">
            ...
            <div class="cauldron-gate__copy">
                ...
                <p>
                    ...
                    Чтобы Дарина знала, кому варить и куда отправить —
            ...
            <form class="cauldron__form" id="cauldron-form"
                ...
                <section class="cauldron-block" data-block="6">
                    ...
                    <div class="cauldron-fields">
                        ...
                        <label class="cauldron-field">
                            ...
                            <span class="cauldron-field__hint">до 280 знаков · Дарина прочитает лично</span>
                        </label>
                    </div>
                </section>
                ...
                <section class="cauldron-block cauldron-block--actions">
                    ...
                    <p class="cauldron-note">
                        Дарина возьмётся в течение дня. О каждом шаге — варка, остывание, отправка — придёт весточка.
                    </p>
                    @else
